...
const reviews = [
  ...
  { name: "Елена П.", tag: "бухгалтер", text: "Встаю на час раньше, делаю 2-3 сделки до работы. Вечером ещё пару. Получается 70-80 доп. к зарплате. Муж подключился — теперь вместе разбираем связки за ужином.", earned: "75 000₽/мес" },
  { name: "Макс Д.", tag: "IT-специалист", text: "Как программист сначала разобрал всю систему на логику. Тут реально работает математика. Автоматизировал часть рутины — теперь трачу минимум времени. ROI стабильный.", highlight: true, earned: "180 000₽/мес" },
  { name: "Света Л.", tag: "2 месяца", text: "Первую неделю просто читала чат и боялась. Вторую — сделала первую сделку с куратором по видеозвонку. Третью — уже сама. Сейчас 60 тыс., и каждый месяц растёт.", earned: "60 000₽/мес" },
  { name: "Фёдор И.", tag: "пенсионер, 63 года", text: "Дочка показала. Два дня объясняла, как телефон работает. Но разобрался. Куратор очень терпеливый. Теперь 45-50 тыс. прибавка к пенсии. Внукам на день рождения нормальные подарки купил.", earned: "48 000₽/мес" },
  { name: "Ксюша Т.", tag: "бывший менеджер", text: "Работала в офисе за 45 тыс., ненавидела каждое утро. Через 3 месяца обучения вышла на 150+. Написала заявление. Начальник звонил — вернись, повысим. Отказала без раздумий.", highlight: true, earned: "153 000₽/мес" },
  { name: "Артём Б.", tag: "1 месяц", text: "Пришёл полным нулём. Крипту видел только в новостях. За месяц — 52 тыс. чистыми. Куратор сказал — для первого месяца отличный результат, дальше будет больше.", earned: "52 000₽/мес" },
  { name: "Марина О.", tag: "домохозяйка", text: "Муж сказал: «очередная ерунда из интернета». Когда показала перевод 90 тыс. на карту — замолчал. Теперь сам записался в следующий поток. Вместе веселее.", earned: "90 000₽/мес" },
]
